...
public class ConverterTests
{
    ...
    public void ConvertFileToDrawingGroup(string filename)
    {
        ...
        ResKeyInfo resKeyInfo = new( ) { Prefix = "Prefix" };
    ...
    public void SvgDirToXamlTest_withNamePrefix( )
    {
        ...
        ResKeyInfo resKeyInfo = new( ) { XamlName = "Test", Prefix = "NamePrefix" };
    ...
    {
        FileSvgReader fileReader = new(null);
        DrawingGroup drawing = fileReader.Read("TestFiles\\Handwheel.svg");
        XmlXamlWriter writer = new(null);
