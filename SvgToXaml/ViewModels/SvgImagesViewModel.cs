...
public class SvgImagesViewModel : ViewModelBase, IDisposable
{
    ...
    {
        FolderBrowserDialog folderDialog = new( ) { Description = "Open Folder", SelectedPath = CurrentDir, ShowNewFolderButton = false };
    ...
    {
        OpenFileDialog openDlg = new( ) { CheckFileExists = true, Filter = "Svg-Files|*.svg*", Multiselect = false };
    ...
    private void ExportDirExecute( )
    {
        ...
        SaveFileDialog saveDlg = new( ) { AddExtension = true, DefaultExt = ".xaml", Filter = "Xaml-File|*.xaml", InitialDirectory = CurrentDir, FileName = outFileName };
